# Samsara\Roster\Processors > TraitInlineProcessor
...
!!! signature "public TraitInlineProcessor->__construct(ReflectionClass $trait, array $aliases)"
    **$trait**
...
!!! signature "public TraitInlineProcessor->compile()"
    **return**
